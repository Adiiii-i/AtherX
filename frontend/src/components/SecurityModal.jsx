    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 glass rounded-2xl p-6 max-w-lg w-full max-h-[85dvh] overflow-y-auto animate-scale-in">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1.5 text-slate-500 hover:text-slate-300 hover:bg-surface-800 transition-colors"
        ...
        <div className="mt-6 rounded-xl bg-stone-500/10 border border-stone-400/20 px-4 py-3">
